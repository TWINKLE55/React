...
const Header = () => {
  return (
    <div className="header">
      <div className="logo">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTZBLbGjAvdzDp-2FyXt80pN1T3JRU834Khug&usqp=CAU" />
      </div>
    ...
    <div className="res-card">
      ...
      <div className="info">
       ...
       { <h2>{data.info.name}</h2> }
        ...
        <h4>{data.info.costForTwo} for two</h4>
  ...
  return (
    <div className="body">
     ...
     {/* not using key (not acceptable)<<<using index<<<<key is prefferable */}
      {dataobject.map((restaurant)=>( <RestaurantCard key={restaurant.info.id} data={restaurant}/>) )}
